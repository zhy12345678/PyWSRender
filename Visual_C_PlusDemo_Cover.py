...
from Visual_C_Plus import Ui_MainWindow
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.set_image_to_graphicsview("G:\\single\\dual_articulated.png", self.graphicsView) #左下
        self.set_image_to_graphicsview("G:\\single\\articulated.png", self.graphicsView_2) #左上
        self.set_image_to_graphicsview("G:\\single\\spherical.png", self.graphicsView_3) #右下
        self.set_image_to_graphicsview("G:\\single\\dual_spherical.png", self.graphicsView_4)#右上
