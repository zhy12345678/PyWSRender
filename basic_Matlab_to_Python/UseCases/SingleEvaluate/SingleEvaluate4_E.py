'''
Example for WSRender Use Case 1: workspace analysis for the ABB_Yumi
和前面的大致覆盖所有情况了，再对所有的single robot的进行检查。
'''
...
#type=dVRK时"Harmonic Mean Manipulability Index","Max Singular","Condition number", 有none
#type= Spherical  ,"Max Singular" 有none
...
out = VisualWS(Dex,evaluate='Reachable', robotnum='SingleArm',color='g')
