...
from MultiRobot_GUI import Ui_MainWindow
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        # self.set_image_to_graphicsview("G:\\single\\dual_articulated.png", self.graphicsView) #1
        # self.set_image_to_graphicsview("G:\\single\\dual_spherical.png", self.graphicsView_2) #2
        # self.set_image_to_graphicsview("G:\\single\\multi_spherical_articulated.png", self.graphicsView_4)  # 2

        self.set_image_to_graphicsview("G:\\single\\Multi45_A.png", self.graphicsView)  # 1
        self.set_image_to_graphicsview("G:\\single\\Multi45_S.png", self.graphicsView_2)  # 2
        self.set_image_to_graphicsview("G:\\single\\Multi45_inter_sa.png", self.graphicsView_3)
        self.set_image_to_graphicsview("G:\\single\\MultiS_A45.png", self.graphicsView_4)
